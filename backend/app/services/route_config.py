SDM_COLLEGE = {"name": "SDM Engineering College, Dharwad", "lat": 15.3919, "lng": 75.0249}
...
def route_polyline(route: dict) -> list[list[float]]:
    return [[stop["lat"], stop["lng"]] for stop in route["stops"]]
